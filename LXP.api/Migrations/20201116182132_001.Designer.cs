            ...
            modelBuilder.Entity("LXP.api.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            FirstName = "GuanXi",
                            HiredDate = new DateTimeOffset(new DateTime(2020, 11, 16, 12, 21, 32, 91, DateTimeKind.Unspecified).AddTicks(7878), new TimeSpan(0, -6, 0, 0, 0)),
                            LastName = "Chen",
            ...
            modelBuilder.Entity("LXP.api.Entities.EmployeeTask", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartTime = new DateTimeOffset(new DateTime(2020, 11, 16, 12, 21, 32, 93, DateTimeKind.Unspecified).AddTicks(744), new TimeSpan(0, -6, 0, 0, 0))
                        },
                        new
                        {
                            TaskName = "CRUS a entity",
                            DeadLine = new DateTimeOffset(new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            StartTime = new DateTimeOffset(new DateTime(2020, 11, 16, 12, 21, 32, 93, DateTimeKind.Unspecified).AddTicks(2206), new TimeSpan(0, -6, 0, 0, 0))
                        },
                        new
                        {
                            TaskName = "Design module",
                            DeadLine = new DateTimeOffset(new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -6, 0, 0, 0)),
                            StartTime = new DateTimeOffset(new DateTime(2020, 11, 16, 12, 21, 32, 93, DateTimeKind.Unspecified).AddTicks(2280), new TimeSpan(0, -6, 0, 0, 0))
                        },
                        new
                        {
                            TaskName = "Take photo",
